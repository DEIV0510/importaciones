 ...
 * lucide-react ya no incluye logotipos de marca, así que se definen aquí para
 * que nunca queden iconos rotos. Heredan el color con `fill="currentColor"`.
 */
...
export function TikTokIcon({ className = '', ...rest }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
